...
const translations = {
  zh: {
    ...
    'control.log': '运行日志',
    'control.log.empty': '等待流程事件',
    'control.log.thinking': '流程',
    'control.log.reply': '输出',
    'control.log.skip': '阻断',
  ...
  en: {
    ...
    'control.log.empty': 'Waiting for flow events',
    'control.log.thinking': 'Flow',
    'control.log.reply': 'Output',
    'control.log.skip': 'Blocked',
